...
VALUES
('João Silva', '123.456.789-00', 'joao.silva@example.com', '(11) 9999-8888',
 (SELECT max(id) FROM ENDERECO WHERE rua = 'Rua das Flores' AND numero = '123'),
 '1980-05-15', '123456789012345', 'TITULAR', NULL),

('Maria Oliveira', '987.654.321-00', 'maria.oliveira@example.com', '(21) 8888-7777',
 (SELECT max(id) FROM ENDERECO WHERE rua = 'Avenida Brasil' AND numero = '456'),
 '1990-10-20', '987654321098765', 'TITULAR', NULL),

('Pedro Souza', '111.222.333-44', 'pedro.souza@example.com', '(11) 7777-6666',
 (SELECT max(id) FROM ENDERECO WHERE rua = 'Rua dos Pinheiros' AND numero = '789'),
 '2005-03-25', '111222333444555', 'DEPENDENTE',(select max(id) from usuarios where nome = 'Maria Oliveira')),

('Ana Costa', '555.666.777-88', 'ana.costa@example.com', '(21) 6666-5555',
 (SELECT max(id) FROM ENDERECO WHERE rua = 'Avenida Brasil' AND numero = '456'),
 '2008-07-30', '555666777888999', 'DEPENDENTE',(select max(id) from usuarios where nome = 'João Silva'));
